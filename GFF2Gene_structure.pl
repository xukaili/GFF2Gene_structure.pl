...
for ($i = 1; $i <= $gene_n; $i++) {
  ...
  print OUTR "rect($mystart + 500, -0.5- $j, $mystart +1000, -0.7- $j, border = \"dodgerblue4\" , col =\"lightsteelblue1\")\n";
  print OUTR "text($mystart + 400, -0.6- $j, \"UTR\", cex=0.7, col=\"black\", pos=4, offset=-1)\n";
  
  print OUTR "rect($mystart + 2000, -0.5- $j, $mystart +2500, -0.7- $j, border = \"dodgerblue4\" , col =\"steelblue3\")\n";
  print OUTR "text($mystart + 1900, -0.6 - $j, \"CDS\", cex=0.7, col=\"black\", pos=4, offset=-1)\n";
  
  print OUTR "rect($mystart + 3700, -0.5- $j, $mystart +4200, -0.7- $j, border = \"dodgerblue4\" , col =\"white\")\n";
  print OUTR "text($mystart + 3400, -0.6 - $j, \"500 bp\", cex=0.7, col=\"black\", pos=4, offset=-1)\n";
  
  print OUTR "text($mystart + 5000, -0.6- $j, \"$ARGV[1]\", cex=0.7, col=\"black\", pos=4, offset=-1)\n";
print OUTR "dev.off()\n";
